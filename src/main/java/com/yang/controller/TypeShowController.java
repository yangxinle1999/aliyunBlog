...
public class TypeShowController {
    ...
    @GetMapping("/types/{id}")
    public String types(@PageableDefault(size = 8,sort = {"createTime"},direction = Sort.Direction.ASC)
...
//    public String typesPage(@PageableDefault(size = 1,sort = {"createTime"},direction = Sort.Direction.ASC)
